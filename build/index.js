...
var _CalendarHeader = __webpack_require__(31);

var _CalendarHeader2 = _interopRequireDefault(_CalendarHeader);

var _CalendarBody = __webpack_require__(28);
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ setEvents: _actions.setEvents }, dispatch);
}
...
var CalendarForm = function (_React$Component) {
  ...
  function CalendarForm(props) {
    ...
    _this.state = { title: '', description: '', date: '' };
  ...
  _createClass(CalendarForm, [{
    ...
    value: function onSubmitForm(event) {
      ...
      this.props.onCreateEvent(this.props.currentDate.year, this.props.currentDate.month + 1, this.props.currentDate.day, this.state.title, this.state.description, function () {
        _this2.props.setView('calendar');
      });
    }
  }, {
    key: 'onDescrChange',
    value: function onDescrChange() {}
  }, {
    key: 'render',
    value: function render() {
      var _this3 = this;
      ...
      var _props$currentDate = this.props.currentDate,
          year = _props$currentDate.year,
          month = _props$currentDate.month,
          day = _props$currentDate.day;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'label',
              { htmlFor: 'event_description', style: { display: 'block' } },
              'Event Title'
            ),
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ setView: _actions.setView }, dispatch);
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CalendarForm);
...
var _CalendarForm = __webpack_require__(13);
...
var CalendarOuter = function (_React$Component) {
  ...
  function CalendarOuter(props) {
    _classCallCheck(this, CalendarOuter);

    return _possibleConstructorReturn(this, (CalendarOuter.__proto__ || Object.getPrototypeOf(CalendarOuter)).call(this, props));
  }
  ...
  _createClass(CalendarOuter, [{
    ...
    value: function renderForm() {
      return _react2.default.createElement(_CalendarForm2.default, { onCreateEvent: this.props.onCreateEvent });
    }
  }, {
    key: 'renderView',
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CalendarOuter);
...
var _EventsReducer = __webpack_require__(36);

var _EventsReducer2 = _interopRequireDefault(_EventsReducer);

var _DateReducer = __webpack_require__(35);

var _DateReducer2 = _interopRequireDefault(_DateReducer);

var _CalendarReducer = __webpack_require__(33);

var _CalendarReducer2 = _interopRequireDefault(_CalendarReducer);

var _ViewReducer = __webpack_require__(37);

var _ViewReducer2 = _interopRequireDefault(_ViewReducer);

var _CurrentDateReducer = __webpack_require__(34);

var _CurrentDateReducer2 = _interopRequireDefault(_CurrentDateReducer);
...
var rootReducer = (0, _redux.combineReducers)({
  ...
  currentDate: _CurrentDateReducer2.default,
...
var Select = function (_React$Component) {
  ...
  function Select(props) {
    ...
    console.log('SELECT: ', _this.state.value);
    return _this;
  }

  _createClass(Select, [{
    key: 'onSelected',
    value: function onSelected(option) {
          ...
          return _react2.default.createElement(
            'li',
            {
              ...
              onClick: function onClick() {
                return _this2.onSelected(option);
              }
            },
            option.name
          );
    ...
    value: function getSelected() {
      ...
      var selected = { name: 'none selected', value: '' };
      var keep = this.props.options.filter(function (option) {
        return option.value === _this3.state.selected.value;
      });
      if (keep.length === 1) {
        selected = keep[0];
      }
...
var _CalendarColumn = __webpack_require__(29);
...
var CalendarColumn = function (_React$Component) {
  ...
  _createClass(CalendarColumn, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'CalendarColumn-wrap' },
        _react2.default.createElement(
          'div',
          { className: 'CalendarColumn-header' },
          this.props.dayOfWeek
        ),
        _react2.default.createElement(
          'div',
          { className: 'CalendarColumn-days' },
          this.renderColumn()
        )
      );
    }
  ...
  _createClass(CalendarDay, [{
    ...
    value: function render() {
      if (typeof this.props.day === 'number') {
        var _style = this.hasEvents() ? this.state.styles.unavailableCell : this.state.styles.cell;
        if (this.hasEvents()) {
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ selectDay: _actions.selectDay }, dispatch);
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CalendarDay);
...
var CalendarHeader = function (_React$Component) {
  ...
  _createClass(CalendarHeader, [{
    ...
    value: function getMonths() {
      var months = [];
      _constants.MONTHS.forEach(function (name, value) {
        months.push({ name: name, value: value });
      });
      return months;
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'calendar-header', style: { textAlign: 'left' } },
        _react2.default.createElement(_Select2.default, {
          onSelected: this.monthChange,
          value: {
            name: _constants.MONTHS[this.props.date.month],
...
var _CalendarOuter = __webpack_require__(25);
  ...
  _createClass(AvailabilityCalendar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { store: store },
        _react2.default.createElement(_CalendarOuter2.default, {
          style: this.styles,
...
exports.default = function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_CURRENT_DATE;
  var action = arguments[1];

  switch (action.type) {
    case _actions.DAY_SELECTED:
...
exports.default = function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_DATE;
  var action = arguments[1];
  ...
  switch (action.type) {
    ...
    case _actions.SET_DATE:
      ...
      var _newState = Object.assign({}, state, action.payload);
...
// module
exports.push([module.i, ".CalendarBody {\n  display: flex;\n  flex-direction: row;\n  justify-content: stretch;\n}\n", ""]);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./CalendarBody.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./CalendarBody.css");
...
// module
exports.push([module.i, ".CalendarColumn-wrap {\n  text-align: center;\n  display: flex;\n  flex: 1;\n  flex-direction: column;\n  justify-content: flex-start;\n}\n.CalendarColumn-header {\n  flex: 1;\n  background-color: #555;\n  padding: 3px 0px;\n  font-size: 0.6rem;\n  text-transform: uppercase;\n  /*background-color: rgb(253, 0, 67);*/\n  color: white;\n}\n", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./CalendarColumn.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./CalendarColumn.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
